...
import defaultUserImage from "../../../header/img/userIcon.svg";

export default function AddFamilyMember() {
  const { fam_id } = useParams(); // URL에서 fam_id 가져오기
  const [requests, setRequests] = useState([
    // 임시 하드코딩
    { name: "고희동", date: "2023-08-01", status: null },
    { name: "정희수", date: "2023-08-02", status: null },
  ]);
          ...
          <S.Content>
            <S.personform>
              ...
              <S.User key="1">
                ...
                <S.UserName>곰돌이 아빠 (고길동)</S.UserName>
              </S.User>
              <S.User key="2">
                <S.ProfileIconWrapper>
                  <img src={defaultUserImage} alt="User Profile" />
                </S.ProfileIconWrapper>
                <S.UserName>곰돌이 누나 (고윤정)</S.UserName>
              </S.User>
            </S.personform>
          </S.Content>
        )}
